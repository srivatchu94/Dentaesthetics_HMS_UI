                ...
                <div className="bg-white rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4 flex-1">
                      <div className={`w-12 h-12 bg-gradient-to-r ${getStatusColor(appointment.status)} rounded-full flex items-center justify-center text-white font-bold text-sm`}>
                  ...
                  {appointment.reasonForVisit && (
                    <div className="mt-4 p-3 bg-slate-50 rounded-lg border-l-4 border-purple-600">
                      ...
                      <p className="text-sm text-slate-800">{appointment.reasonForVisit}</p>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      ...
                      <p className="font-semibold text-slate-800">{selectedAppointment.phoneNumber || 'N/A'}</p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <p className="text-xs text-slate-600 font-semibold">Email</p>
                      <p className="font-semibold text-slate-800 truncate">{selectedAppointment.email || 'N/A'}</p>
                    </div>
                    <div className="bg-pink-50 p-4 rounded-lg">
                      <p className="text-xs text-slate-600 font-semibold">Age</p>
                      <p className="font-semibold text-slate-800">{selectedAppointment.age || 'N/A'}</p>
                    </div>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="text-xs text-slate-600 font-semibold">Gender</p>
                      <p className="font-semibold text-slate-800">{selectedAppointment.gender || 'N/A'}</p>
                    </div>
                  </div>
                </div>
                      ...
                      <>
                        <div className="bg-indigo-50 p-4 rounded-lg">
                          ...
                          <p className="font-semibold text-slate-800">
                            {new Date(selectedAppointment.appointmentDate).toLocaleDateString()} {selectedAppointment.startTime} - {selectedAppointment.endTime || 'N/A'}
                          </p>
                        </div>
                        <div className="bg-purple-50 p-4 rounded-lg">
                        ...
                        <div className="bg-indigo-50 p-4 rounded-lg">
                          ...
                          <p className="font-semibold text-slate-800">{selectedAppointment.durationMinutes || 'N/A'} minutes</p>
                        </div>
                      </>
                    )}
                  </div>
